...
describe('State', () => {
	describe('Space', () => {
		it('Instance of Space with "0"', () => {
			const state = State.from(0);
			assert.ok(state.isEmpty(), 'Should be empty');
			assert.deepStrictEqual(
				state.valueOf(),
				0,
				'Player should have a value of 0',
			);
			assert.deepStrictEqual(
				state.toString(),
				' ',
				'Player should have a symbol of " "',
			);
		});

		it('Instance of Space with " "', () => {
	...
	describe('MoveX', () => {
		it('Instance of MoveX with "-1"', () => {
			...
			assert.deepStrictEqual(
				state.valueOf(),
				-1,
				'Player should have a value of -1',
			);
			assert.deepStrictEqual(
				state.toString(),
				'X',
				'Player should have a symbol of "X"',
			);
		});

		it('Instance of MoveX with "X"', () => {
	...
	describe('MoveO', () => {
		it('Instance of MoveX with "1"', () => {
			...
			assert.deepStrictEqual(
				state.toString(),
				'O',
				'Player should have a symbol of "O"',
			);
		});

		it('Instance of MoveX with "O"', () => {
